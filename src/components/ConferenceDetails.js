...
console.log(props,"PROPS CONE")
    ...
    <React.Fragment>
      ...
      <Container maxWidth="md">
        <div className={classes.root}>
          <Paper variant="outlined" style={{ borderRadius: "6px", padding:"2%" }}>
            <Typography
              variant="h2"
 ...
 <Typography>Price:{props.conference.price}</Typography>
  <Typography><img src={props.conference.logo_url}/></Typography>
  <LanguageIcon color="secondary" />
  <Typography>{props.conference.link}</Typography>
  <LocationOnIcon color="secondary" />

  <Typography>{props.conference.location.city},{props.conference.location.country} </Typography>
          </Paper>
          </div>
